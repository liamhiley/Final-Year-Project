function [] = numTransitions(clipno,group)
...
%   test video
    ...
    mnGz = [];
    numSeg = 15;
    numTrans = zeros(n_subjects,numSeg);    
...
%       for segSz clip segments of approx. equal length each
        for t_step = 0:numSeg - 1
            ...
            numTrans(subject, t_step+1) = trans;
        end
    end
    save(strcat(group,'Clip',int2str(clipno),'numTransitions.mat'),'numTrans');
end